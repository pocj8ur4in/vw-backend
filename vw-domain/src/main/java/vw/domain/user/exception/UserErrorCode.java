...
public enum UserErrorCode implements BaseErrorCode {
	...
	ALREADY_EXIST_EMAIL(BAD_REQUEST, "USER_400_3", "해당 이메일이 이미 존재합니다."),
	@ExplainError("닉네임이 이미 존재하는 경우")
	ALREADY_EXIST_NICKNAME(BAD_REQUEST, "USER_400_4", "해당 닉네임이 이미 존재합니다."),
	@ExplainError("아이디가 공란인 경우")
	EMPTY_ID(BAD_REQUEST, "USER_400_5", "아이디를 입력해주세요."),
	@ExplainError("이메일이 공란인 경우")
	EMPTY_EMAIL(BAD_REQUEST, "USER_400_6", "이메일을 입력해주세요."),
	@ExplainError("닉네임이 공란인 경우")
	EMPTY_NICKNAME(BAD_REQUEST, "USER_400_7", "닉네임을 입력해주세요."),
	@ExplainError("아이디의 길이가 잘못된 경우")
	INCORRECT_ID_LENGTH(BAD_REQUEST, "USER_400_8", "아이디 길이가 잘못되었습니다. 5~16자로 해주세요."),
	@ExplainError("닉네임의 길이가 잘못된 경우")
	INCORRECT_NICKNAME_LENGTH(BAD_REQUEST, "USER_400_9", "닉네임 길이가 잘못되었습니다. 1~12자로 해주세요."),
	@ExplainError("아이디에 알파벳 대소문자와 숫자 외의 문자가 사용된 경우")
	INCORRECT_ID(BAD_REQUEST, "USER_400_10", "아이디 형식이 잘못되었습니다. 알파벳 대소문자와 숫자만 사용 가능합니다."),
	@ExplainError("닉네임에 알파벳 대소문자, 한글, 숫자 외의 문자가 사용된 경우")
	INCORRECT_NICKNAME(BAD_REQUEST, "USER_400_11", "닉네임 형식이 잘못되었습니다. 한글, 알파벳 대소문자, 숫자만 사용 가능합니다."),
	@ExplainError("이메일의 형식이 잘못된 경우")
	INCORRECT_EMAIL(BAD_REQUEST, "USER_400_12", "이메일 형식이 잘못되었습니다."),
	@ExplainError("비밀번호 형식이 잘못된 경우")
	INCORRECT_PASSWORD(BAD_REQUEST, "USER_400_13", "비밀번호 형식이 잘못되었습니다."),
	@ExplainError("비밀번호와 비밀번호 확인이 일치하지 않는 경우")
	DIFFERENT_PASSWORD(BAD_REQUEST, "USER_400_14", "입력한 비밀번호와 비밀번호 확인이 서로 일치하지 않습니다."),
